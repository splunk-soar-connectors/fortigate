...
This table lists the configuration variables required to operate FortiGate. These variables are specified when configuring a FortiGate asset in Splunk SOAR.
