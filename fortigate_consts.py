...
FORTIGATE_REST_RESP_FORBIDDEN_MESSAGE = 'Request is missing CSRF token or administrator is missing access ' \
                                    'profile permissions'
...
FORTIGATE_REST_RESP_FAIL_DEPENDENCY_MESSAGE = 'Fail dependency can be duplicate resource, missing required ' \
